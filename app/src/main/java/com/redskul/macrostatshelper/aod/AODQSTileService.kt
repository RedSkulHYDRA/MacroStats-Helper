...
class AODQSTileService : BaseQSTileService() {
    ...
    private fun showAODDialog() {
        val options = listOf(
            AODManager.AODState.OFF         to getString(R.string.aod_state_off),
            AODManager.AODState.ALWAYS_ON   to getString(R.string.aod_state_always_on),
            AODManager.AODState.SCHEDULE    to getString(R.string.aod_state_schedule),
            AODManager.AODState.TAP_TO_SHOW to getString(R.string.aod_state_tap_to_show)
        )
        ...
        AlertDialog.Builder(this, dialogTheme)
            .setTitle(getString(R.string.aod_heading))
            .setView(radioGroup)
